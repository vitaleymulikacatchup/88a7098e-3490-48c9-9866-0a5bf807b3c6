...
export const metadata: Metadata = {
  title: "TechFlow Solutions - IT Services & Digital Transformation",
  description: "Transform your business with cutting-edge IT solutions, cloud computing, cybersecurity, and digital transformation services. Expert consulting for modern enterprises.",
  keywords: "IT services, digital transformation, cloud computing, cybersecurity, business automation, technology consulting",
  metadataBase: new URL("https://techflow-solutions.com"),
  alternates: {
    canonical: "https://techflow-solutions.com"
  },
  openGraph: {
    title: "TechFlow Solutions - IT Services & Digital Transformation",
    description: "Expert IT solutions and digital transformation services for modern businesses. Cloud, security, and automation specialists.",
    siteName: "TechFlow Solutions",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763474968068-5w3vwrtd.jpg",
  ...
  twitter: {
    ...
    title: "TechFlow Solutions - IT Services & Digital Transformation",
    description: "Expert IT solutions and digital transformation services for modern businesses.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763474968068-5w3vwrtd.jpg"]
  },
  robots: {
    index: true,
    follow: true
